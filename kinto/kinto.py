...
define_keymap(re.compile(chromeStr, re.IGNORECASE),{
    ...
    K("RC-Left"):           K("M-Left"),            # Page nav: Back to prior page in history (conflict with wordwise) -- josephz: keep!
    K("RC-Right"):          K("M-Right"),           # Page nav: Forward to next page in history (conflict with wordwise) -- josephz: keep!
...
define_keymap(re.compile(browserStr, re.IGNORECASE),{
    ...
    # K("RC-M-Left"):             K("C-Page_Up"),     # Go to prior tab -- josephz: remove!
    # K("RC-M-Right"):            K("C-Page_Down"),   # Go to next tab -- josephz: remove!
...
define_keymap(lambda wm_class: wm_class.casefold() not in remotes,{
    # K("RC-Space"): K("Alt-F1"),                   # Default SL - Launch Application Menu (gnome/kde) -- josephz: remove!
